...
public enum Serializer implements Label {
  STRING("字符串", STRING_SERIALIZER, STRING_SERIALIZER),
  DEFAULT("默认", BYTE_ARRAY_SERIALIZER, BYTE_ARRAY_SERIALIZER),
  CONFLUENT("聚合",KAFKA_AVRO_SERIALIZER, BYTE_ARRAY_SERIALIZER);
