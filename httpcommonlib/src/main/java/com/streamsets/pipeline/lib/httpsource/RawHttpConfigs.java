...
//      description = "Maximum number of concurrent requests allowed by the origin.",
  ...
  @ConfigDef(
      ...
      label = "应用标识",
      description = "只有携带此标识ID的HTTP请求才会被接受。",
...
//      description = "Only HTTP requests presenting this token will be accepted.",
  ...
  @ConfigDef(
      ...
      defaultValue = "false",
      label = "请求地址含应用标识",
      description = "在请求地址中的查询参数中包含标识ID而不是请求头中使用，http://localhost:8000?sdcApplicationId=<Application ID>",
