...
public enum TaskType implements Label {
  CREATE_EMPTY_FILE("创建空文件", HdfsMetadataExecutorEvents.FILE_CREATED),
  CHANGE_EXISTING_FILE("更改原有文件元信息", HdfsMetadataExecutorEvents.FILE_CHANGED),
  REMOVE_FILE("删除目录或文件", HdfsMetadataExecutorEvents.FILE_REMOVED),
