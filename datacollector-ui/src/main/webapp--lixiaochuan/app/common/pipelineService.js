  ...
  .service('pipelineService', function(pipelineConstant, api, $q, $translate, $modal, $location, $route, _) {
    ...
    this.getTextELConstantDefinitions = function() {
      return [
        ...
        {
          name: "BYTE",
          description: "Byte类型字段",
          // description: "Field Type Byte",
          returnType: "Type"
        },
        {
          name: "BYTE_ARRAY",
          description: "Byte数组类型字段",
          // description: "Field Type Byte Array",
          returnType: "Type"
        },
        {
          name: "CHAR",
          description: "Char类型字段",
        ...
        {
          name: "DATETIME",
          description: "Date Time类型字段",
          // description: "Field Type Date Time",
          returnType: "Type"
        },
        {
          name: "TIME",
          description: "Time类型字段",
          // description: "Field Type Time",
          returnType: "Type"
        },
        {
          name: "DECIMAL",
          description: "Decimal类型字段",
        ...
        {
          name: "LONG",
          description: "Long类型字段",
          // description: "Field Type Long",
          returnType: "Type"
        },
        {
          name: "SHORT",
          description: "Short类型字段",
          // description: "Field Type Short",
          returnType: "Type"
        },
        {
          name: "STRING",
          description: "String类型字段",
          // description: "Field Type String",
          returnType: "Type"
        },
        {
          name: "CREDENTIAL",
          description: "Credential类型字段",
