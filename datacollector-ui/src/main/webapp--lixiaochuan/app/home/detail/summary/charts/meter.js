  ...
  .controller('MeterBarChartController', function($scope, $rootScope, pipelineConstant, $filter, $translate, api) {
    ...
    var updatedLatestData = function() {
      ...
      meterChartData['输入'] = [
        ...
        ['平均值' , $scope.summaryMeters.inputRecords.mean_rate ]
      ...
      meterChartData['输出'] = [
        ...
        ['平均值' , $scope.summaryMeters.outputRecords.mean_rate ]
      ...
      meterChartData['错误'] = [
        ...
        ['平均值' , $scope.summaryMeters.errorRecords.mean_rate ]
