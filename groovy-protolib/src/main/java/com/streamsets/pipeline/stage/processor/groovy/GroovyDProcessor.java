...
public class GroovyDProcessor extends DProcessor {
  ...
  @ConfigDef(
      ...
      defaultValue = "BATCH",
      label = "处理方式",
      description = "如果按记录方式，处理器负责记录异常处理，如果按批次方式，Groovy脚本必须负责记录异常处理。",
...
//      label = "Init Script",
      ...
      description = "此处放置初始化代码。任务验证、启动时执行此脚本",
      displayPosition = 20,
      group = "GROOVY",
...
//      label = "Script",
  ...
  @ConfigDef(
      ...
      label = "销毁脚本",
      description = "此处放置清理代码。任务停止时执行此脚本",
...
//      description = "Place cleanup code here. Called on pipeline stop.",
  ...
  @ConfigDef(
      ...
      defaultValue = "false",
      label = "启用invokedynamic编译",
      description = "根据使用情况，可能提高或降低脚本性能。",
