...
//      group = "JAVASCRIPT"
          ...
          defaultValue = "BATCH",
          label = "处理方式",
          description = "如果“按记录记录”，处理器负责记录错误处理，如果“批量按批处理”，则JavaScript必须处理记录错误处理",
          displayPosition = 10,
          group = "JAVASCRIPT"
  )
  ...
  @ConfigDef(
      ...
      label = "初始化脚本",
      description = "填写初始化脚本. 在任务初始化/验证时执行.",
//      label = "Init Script",
