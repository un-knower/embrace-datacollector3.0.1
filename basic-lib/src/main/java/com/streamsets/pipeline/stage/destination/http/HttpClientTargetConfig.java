...
//      group = "DATA_FORMAT"
          defaultValue = "JSON",
          label = "数据格式",
          description = "HTTP返回的数据格式. 返回的内容将在记录中替换解析.",
          displayPosition = 1,
          group = "DATA_FORMAT"
  )
...
//      group = "HTTP"
          defaultValue = "true",
          label = "每批单次请求",
          description = "在同一批次记录中仅生成一次HTTP请求",
          displayPosition = 141,
          group = "HTTP"
  )
