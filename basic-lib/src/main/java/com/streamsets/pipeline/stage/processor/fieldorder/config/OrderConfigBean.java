...
//    displayPosition = 30
    ...
    defaultValue="TO_ERROR",
    label = "缺失字段",
    description = "对不具有所有待排序字段的记录所执行的操作",
    group = "ORDER",
    displayPosition = 30
  )
...
//    displayPosition = 60
    ...
    defaultValue="TO_ERROR",
    label = "其他字段",
    description = "对未在顺序列表中指定的其他字段执行的操作",
    group = "ORDER",
    displayPosition = 60
  )
