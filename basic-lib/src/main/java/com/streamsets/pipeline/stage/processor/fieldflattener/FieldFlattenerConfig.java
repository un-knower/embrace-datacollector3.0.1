...
//    triggeredByValue = { "false" }
      ...
      label = "目标字段",
      description = "字段（必须是MAP或MAP_LIST），进入被平铺格式化的字段",
      displayPosition = 25,
      group = "FLATTEN",
      dependsOn = "flattenInPlace",
      triggeredByValue = { "false" }
