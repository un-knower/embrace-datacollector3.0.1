...
public enum Errors implements ErrorCode {
  ...
  RECORDFS_00("文件最大大小'{}'必须大于等于0"),
  RECORDFS_01("目录'{}'不存在"),
  RECORDFS_02("路径'{}'不是一个目录"),
...
//  RECORDFS_02("Path '{}' is not a directory"),
  ...
  RECORDFS_03("滚动间隔'{}'必须大于0, 实际值是'{}'"),
  RECORDFS_04("滚动间隔'{}'不是一个表达式"),
  RECORDFS_05("无法向文件中写入记录'{}': {}"),
  RECORDFS_06("无法滚动操作文件'{}': {}"),
  RECORDFS_07("无法滚动操作文件'{}': {}"),
