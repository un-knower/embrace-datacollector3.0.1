...
public enum DataFormat implements Label {
  ...
  DELIMITED("字符分割", DataParserFormat.DELIMITED, DataGeneratorFormat.DELIMITED),
//  DELIMITED("Delimited", DataParserFormat.DELIMITED, DataGeneratorFormat.DELIMITED),
  ...
  SDC_JSON("采集器记录", DataParserFormat.SDC_RECORD, DataGeneratorFormat.SDC_RECORD),
//  SDC_JSON("SDC Record", DataParserFormat.SDC_RECORD, DataGeneratorFormat.SDC_RECORD),
  LOG("日志", DataParserFormat.LOG, null),
//  LOG("Log", DataParserFormat.LOG, null),
  ...
  WHOLE_FILE("整个文件", DataParserFormat.WHOLE_FILE, DataGeneratorFormat.WHOLE_FILE),
