...
public enum LogMode implements Label {
  ...
  COMMON_LOG_FORMAT("Common Log格式"),
  COMBINED_LOG_FORMAT("Combined Log格式"),
  APACHE_ERROR_LOG_FORMAT("Apache Error Log格式"),
  APACHE_CUSTOM_LOG_FORMAT("Apache Access Log自定义格式"),
  REGEX("正则表达式"),
  GROK("Grok模式"),
  LOG4J("Log4j格式")
