...
public class NetflowDataParserFactory extends DataParserFactory {
  ...
  public static final String OUTPUT_VALUES_MODE_LABEL = "记录的生成方式";
  public static final String OUTPUT_VALUES_MODE_TOOLTIP = "确定从流中生成的记录中包含的数据。仅适用于NetFlow 9";

  public static final String MAX_TEMPLATE_CACHE_SIZE_LABEL = "最大缓存模板个数";
  public static final String MAX_TEMPLATE_CACHE_SIZE_TOOLTIP = "控制全局缓存模板的最大数目。" +
          "使用最近最少使用(LRU)策略驱逐数据，即判断最近被使用的时间，距离当前最远的数据优先被淘汰" +
          "为-1时表示无限。只适用于流量9。";

  public static final String TEMPLATE_CACHE_TIMEOUT_MS_LABEL = "模板缓存超时时间(ms)";
  public static final String TEMPLATE_CACHE_TIMEOUT_MS_TOOLTIP = "控值模板缓存生存时间，从上一次使用计算。-1表示永不过期。仅适用于Netflow 9";
