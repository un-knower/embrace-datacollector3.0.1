...
public enum Errors implements ErrorCode {
  XML_GENERATOR_00("记录根字段必须是Map或ListMap，实际是：'{}'"),
  XML_GENERATOR_01("记录字段'{}'的类型在JSON序列化中不支持"),
  XML_GENERATOR_02("记录生成的XML不符合指定的模式: {}"),
  XML_GENERATOR_03("记录没有根字段"),
  XML_GENERATOR_04("记录根字段必须有一个元素"),
  XML_GENERATOR_05("记录根字段不能为List"),
  XML_GENERATOR_06("记录未生成任何XML"),
  XML_GENERATOR_07("'{}'属性前缀未定义命名空间"),
  XML_GENERATOR_08("'{}'元素前缀未定义命名空间"),
