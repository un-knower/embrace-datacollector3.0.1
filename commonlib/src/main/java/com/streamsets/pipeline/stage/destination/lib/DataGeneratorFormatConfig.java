...
//    description = "Replaces new lines characters with configured string constant",
  ...
  @ConfigDef(
    ...
    defaultValue = " ",
    label = "替代换行符",
    description = "将用于替代原换行符。使用空字符串将删除换行符号。",
...
//    description = "String field that will be written to the destination",
  ...
  @ConfigDef(
      ...
      label = "记录分隔符",
      description = "用于记录之间相互分离的符号, 默认为换行符",
...
//    label = "On Missing Field",
  ...
  @ConfigDef(
    ...
    defaultValue = "false",
    label = "空值插入记录分隔符",
    description = "指定是否在遇到空值时插入记录分隔符（字段中没有文本）",
...
//      label = "Schema Subject",
  ...
  @ConfigDef(
      ...
      type = ConfigDef.Type.STRING,
      label = "元信息对象",
      description = "若元信息注册URL不为空，则使用此值（不为空）进行注册",
//      label = "Schema Subject",
...
//    description = "Field to write data to Kafka",
  ...
  @ConfigDef(
    ...
    defaultValue = "",
    label = "Protobuf描述文件",
    description = "Protobuf描述文件(.desc)相对路径(相对于SDC资源目录)",
...
//      description = "The action to perform when the file already exists.",
  ...
  @ConfigDef(
      ...
      defaultValue = "false",
      label = "包含Checksum信息",
      description = "在整个文件转换事件中包含checksum信息.",
...
//      description = "Includes checksum information in whole file transfer events.",
  ...
  @ConfigDef(
      ...
      defaultValue = "MD5",
      label = "Checksum算法",
      description = "用于文件完整性校验的Checksum算法",
...
//      description = "The checksum algorithm for calculating checksum for the file.",
  ...
  @ConfigDef(
      ...
      defaultValue = "true",
      label = "优化格式",
      description = "优化XML格式以提高可读性(会占用更多的存储空间).",
//      label = "Pretty Format",
